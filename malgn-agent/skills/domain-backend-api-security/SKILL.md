...
**참고**: 이 체크리스트는 OWASP Top 10(A01/A03 포함, 2026-08-07 `knowledge/security/owasp-security-checklist.md`에서 분산 병합) 기반 백엔드 보안 가이드입니다. §2의 4계층 방어 구조와 §6 외부 호출 안전성은 2026-08-24 보안 스킬 정리에서 별도 문서로 갈라져 있던 것을 이 문서로 흡수한 것입니다.
