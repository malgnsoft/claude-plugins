...
- 본문이 이 파일에 그대로 있는 절(§2의 실행 커맨드·§3.5·§4.1·§4.2·§6·§7)은 따로 열 것이 없다. §5는 공통 절차가 여기 있고 산출물 유형별 추가 항목만 별도 파일로 나가 있다. 매 위임·매 검증마다 걸리는 짧은 규율이거나, 플러그인 경로를 담고 있어 여기 있어야 하는 것들이다.
