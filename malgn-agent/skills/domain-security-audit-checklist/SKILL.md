...
### 6. XSS 방지 (Cross-Site Scripting) *(OWASP A07 흡수)*
...
**참고**: 이 체크리스트는 NIST Cybersecurity Framework, CIS Controls, OWASP Top 10(A02 암호화 실패·A07 XSS·A09 로깅/모니터링 실패)에 기반합니다. 프로젝트 규모와 규제 요건에 맞게 조정하세요.
