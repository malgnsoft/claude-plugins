...
- **호출자**: PM의 발표/문서 자료 제작 단계(Skill `project-orchestration`의 팀 구성 원칙 "발표=presenter"), 또는 사용자 직접 요청. presenter 자신은 승인·실행·에스컬레이션 권한이 없다 — 산출물 확정·전달은 PM이 검증 후 결정한다(pm.md PM 권한 참조표).
