...
| persona-script-skill-consistency-auditor.md | 문서가 서술하는 약속(옵션·임계값·근거)과 코드 구현이 실제로 정확히 일치하는지 한 줄씩 대조하는 정합성 감사관 | 수렴 | 2026-08-10 | bin-script-reach-path / 1차 (직전: token-usage-collection-design-2026-08-19 / 3차) |
...
| persona-enforcement-gap-auditor.md | 원칙 문장이 체크리스트/영속 필드로 강제 가능한지, 아니면 자기판단에 맡겨진 서술인지 가르는 강제력 격차 감사관 | 수렴 | 2026-08-10 | bin-script-reach-path / 1차 (직전: reviewer-repeat-review-reduction / 1차) |
...
| persona-semantic-force-preservation-auditor.md | 삭제·치환 리팩터링 후 규칙의 경계·강제력이 조용히 약해지지 않았는지 원문과 한 줄씩 대조하는 의미강도 감사관 | 수렴 | 2026-08-22 | bin-script-reach-path / 1차 (직전: knowledge-dead-skill-refs / 1차) |
